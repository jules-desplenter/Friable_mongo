...
namespace Friable_mongo.InfoModels.DTO
{
    public class FramingDTO
    {
        ...
        public string? MechanicalProblemsSerialized
        {
            ...
            set => MechanicalProblems = JsonConvert.DeserializeObject<List<string>>(MechanicalProblemsSerialized);
        }
        ...
        public string? ChemicalProblemsSerialized
        {
            ...
            set => ChemicalProblems = JsonConvert.DeserializeObject<List<string>>(ChemicalProblemsSerialized);
        }
        ...
        public string? BiologicalProblemsSerialized
        {
            ...
            set => BiologicalProblems = JsonConvert.DeserializeObject<List<string>>(BiologicalProblemsSerialized);
        }
        ...
        public string? AestheticProblemsSerialized
        {
            ...
            set => AestheticProblems = JsonConvert.DeserializeObject<List<string>>(AestheticProblemsSerialized);
        }
    }
}
